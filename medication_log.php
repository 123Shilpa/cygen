...
<?php
$squery = "SELECT * FROM medication_log where PatientId = '" . $_SESSION['PatientId'] . "'";
...
if ($rowcount == 0) {
	...
	<form class="form-horizontal" id="medical_log" method="post" action='ajaxMedicationLog.php' style="clear:both" >
	<div class="profile">
	  <div class="">
		 <div class="col-sm-12 table-bar" style="width: 100%;" >
  ...
  $(document).ready(function(e) {
    $( ".pres_date" ).datepicker({
		...
		// maxDate:new Date()
							...
							<td ><input name="MedicationName[]" class="txtMedicationName medicationname" id="txtMedicationName"></td>
							<td ><input name="Doctor[]" class="txtDoctor doctor" id="txtDoctor"></td>
							<td ><input name="Dosage[]" class="txtDosage dosage" id="txtDosage"></td>
							<td ><input name="TimesPerDay[]" class="txtTimesPerDay timeperday" id="txttxtTimesPerDay"></td>
							<td ><input name="WithFood[]" class="txtWithFood withfood" id="txtWithFood"></td>
							<td ><input name="Reason[]" class="txtReason reason" id="txttxtReason"></td>
							<td ><input name="Reactions[]" class="txtReactions reactions" id="txtReactions"></td>
						  </tr>						
						 </tbody>
					  </table></div>
							...
							<button type="submit" name="submit" id="submit"class="btn btn-success" style="float:right !important">Submit</button>
							</div>
							</div>
...
$('input:radio[name=optradio]').click(function(){	
	...
	$("#addButton").on('click', (function () {
		...
		if (validateTextBoxesGroup(counter))
		{
			...
			newTextBoxDiv.after().html('<td ><input name="PrescriptionDate[]" class="txtPrescriptionDate'+counter+' pres_date" id="txtPrescriptionDate'+counter+'"></td><td ><input name="MedicationName[]"  class="txtMedicationName'+counter+'" id="txtMedicationName'+counter+'"></td><td ><input name="Doctor[]" class="txtDoctor'+counter+'" id="txtDoctor'+counter+'"></td><td ><input name="Dosage[]" class="txtDosage'+counter+'" id="txtDosage'+counter+'"></td><td ><input name="TimesPerDay[]" class="txtTimePerDay'+counter+'" id="txtTimePerDay'+counter+'"></td><td ><input name="WithFood[]" class="txtWithFood'+counter+'" id="txtWithFood'+counter+'"></td><td ><input name="Reason[]" class="txtReasons'+counter+'" id="txtReasons'+counter+'"></td><td ><input name="Reactions[]" class="txtReactions'+counter+'" id="txtReactions'+counter+'"></td>');
