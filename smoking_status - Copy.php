...
if (!empty($_POST)) {
    ...
    $sql = "INSERT INTO smoking_status  (PatientId , Smoker ,PerDay ,LastStopSmoke , EverSmoked , SmokingPeriod , SmokingPeriod, IndoorTobacco, IndoorTobaccoDaily, Status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $q = $pdo->prepare($sql);
    $q->execute(array($_SESSION['PatientId'], $Smoker, $PerDay, $LastStopSmoke, $EverSmoked, $SmokingPeriod, $SmokingPeriod, $IndoorTobacco, $IndoorTobaccoDaily, $Status));
...
<span id="LastStopSmokeSpan1" style="display:none; float:right" class=" inner-box col-lg-12 col-md-12 col-sm-12 col-xs-12 pd0">
<div>
<div class="Sub-head">How Many Per Day</div>
<div class="questionary-box">
<div class="row">
...
<span id="LastStopSmokeSpan2" style="display:none; float:right" class=" inner-box col-lg-12 col-md-12 col-sm-12 col-xs-12 pd0">
<div>
<div class="Sub-head">How Many Per Day</div>
<div class="questionary-box">
<div class="row">
...
<span id="LastStopSmokeSpan3" style="display:none; float:right" class=" inner-box col-lg-12 col-md-12 col-sm-12 col-xs-12 pd0">
<div>
<div class="Sub-head">How Many Per Day</div>
<div class="questionary-box">
<div class="row">
...
<span id="LastStopSmokeSpan4" style="display:none; float:right" class=" inner-box col-lg-12 col-md-12 col-sm-12 col-xs-12 pd0">
<div>
<div class="Sub-head">How Many Per Day</div>
<div class="questionary-box">
<div class="row">
...
<span id="LastStopSmokeSpan5" style="display:none; float:right" class=" inner-box col-lg-12 col-md-12 col-sm-12 col-xs-12 pd0">
<div>
<div class="Sub-head">How Many Per Day</div>
<div class="questionary-box">
<div class="row">
...
<span id="LastStopSmokeSpan6" style="display:none; float:right" class=" inner-box col-lg-12 col-md-12 col-sm-12 col-xs-12 pd0">
<div>
<div class="Sub-head">How Many Per Day</div>
<div class="questionary-box">
<div class="row">
...
<!--Give the time when you last stopped smoking-->
            ...
            if (radioValue === 'Today or yesterday') {
                $("#LastStopSmokeSpan1").show();
            } else {
                $("#LastStopSmokeSpan1").hide();
            }
        });
            ...
            if (radioValue === '2 days – 6 days ago') {
                $("#LastStopSmokeSpan2").show();
            } else {
                $("#LastStopSmokeSpan2").hide();
            }
        });
            ...
            if (radioValue === '1 week – less than 1 month ago') {
                $("#LastStopSmokeSpan3").show();
            } else {
                $("#LastStopSmokeSpan3").hide();
            }
        });
            ...
            if (radioValue === '1 month – less than 1 year ago') {
                $("#LastStopSmokeSpan4").show();
            } else {
                $("#LastStopSmokeSpan4").hide();
            }
        });
            ...
            if (radioValue === '1 – 5 years ago') {
                $("#LastStopSmokeSpan5").show();
            } else {
                $("#LastStopSmokeSpan5").hide();
            }
        });
            ...
            if (radioValue === 'More than 5 years ago') {
                $("#LastStopSmokeSpan6").show();
            } else {
                $("#LastStopSmokeSpan6").hide();
            }
        });
...
$(document).ready(function(){
	$("#btnSaveNext").click(function(){
		var isvalid=true;
	if($("input[name=PerDay]").is(':visible'))
	{			
		if(!$("input[name=PerDay]").is(':checked'))
		{
			alert("PerDay");
			isvalid=false;
		}
	}
	if($("input[name=IndoorTobaccoDaily]").is(':visible'))
	{			
		if(!$("input[name=IndoorTobaccoDaily]").is(':checked'))
		{
			alert("IndoorTobaccoDaily");
			isvalid=false;
		}

	}
	
	if($("input[name=LastStopSmoke]").is(':visible'))
	{			
		if(!$("input[name=LastStopSmoke]").is(':checked'))
		{
			alert("LastStopSmoke");
			isvalid=false;
		}
	...
	if($("input[name=EverSmoked]").is(':visible'))
	{			
		if(!$("input[name=EverSmoked]").is(':checked'))
		{
			alert("EverSmoked");
			isvalid=false;
		}
	...
	if($("input[name=SmokingPeriod]").is(':visible'))
	{			
		if(!$("input[name=SmokingPeriod]").is(':checked'))
		{
			alert("SmokingPeriod");
			isvalid=false;
		}
		...
		if(!$("input[name=IndoorTobacco]").is(':checked'))
		{
			alert("IndoorTobacco");
			isvalid=false;
