...
if (isset($_POST['submit']) and $_SERVER['REQUEST_METHOD'] == "POST") {
  		...
  		$sql = mysql_query("UPDATE profilereport SET SupplementLog = '7' WHERE PatientId='" . $_SESSION['PatientId'] . "'");
                    ...
                    for ($i = 0; $i < count($PrescriptionDate); $i++) {
                       //echo "<script type = 'text/javascript'> alert('loop started'); </script>";
                        ...
                        $Status = '1';
                       $insert = "INSERT INTO supplement_log(
																	 PatientId,
																	 PrescriptionDate,
																	 MedicationName,
																	 Doctor, Dosage,
               ...
               // echo "<script type = 'text/javascript'> window.location = 'supplement_log.php'; </script>";
				 echo "<script type = 'text/javascript'> alert('Successfully Inserted');window.location = 'daily_medication_log.php'; </script>";
                } 
